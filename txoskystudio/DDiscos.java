 ...
 * @author usutarde1
 */
public class DDiscos extends javax.swing.JDialog {
    ...
    public DDiscos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void insertarArtistas() {
        ...
        Connection con = getConnection();
        try {
            String sql = "INSERT INTO artistas (CodigoArtista, Nombre, Genero, Edad, Discos) VALUES (?,?,?,?,?)";
            ps = con.prepareStatement(sql);
            ps.setString(1, txf_id.getText());
            ps.setString(2, txf_nombre.getText());
            ps.setString(3, txf_estilos.getText());
